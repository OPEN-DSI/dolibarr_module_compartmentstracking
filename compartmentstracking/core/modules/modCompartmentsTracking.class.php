...
/**
 * 	\defgroup   compartmentstracking     Module CompartmentsTracking
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/compartmentstracking/core/modules directory.
 *  \file       htdocs/compartmentstracking/core/modules/modCompartmentsTracking.class.php
 *  \ingroup    compartmentstracking
 *  \brief      Description and activation file for module CompartmentsTracking
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module CompartmentsTracking
 */
class modCompartmentsTracking extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
        ...
        $this->db = $db;
        $langs->load('opendsi@compartmentstracking');
		...
		$this->rights_class = 'compartmentstracking';
		...
		$this->description = "Description of module CompartmentsTracking";
		...
		$this->picto='opendsi@compartmentstracking';
		...
		//                        );
		$this->module_parts = array(
			'hooks' => array('stockproductcard', 'movementlist', 'ordersuppliercard', 'synergiestechmassstockmove'),
			'triggers' => 1,
		);
		...
		$this->config_page_url = array("about.php@compartmentstracking");
		...
		$this->langfiles = array("compartmentstracking@compartmentstracking", "opendsi@compartmentstracking");
        ...
        // Additionnal Compartments tabs in other modules.
		$this->tabs = array(
			'stock:+compartments1:Compartments:compartmentstracking@compartmentstracking:/compartmentstracking/tabs/entrepot.php?id=__ID__',
			'product:+compartments2:Compartments:compartmentstracking@compartmentstracking:/compartmentstracking/tabs/product.php?id=__ID__',
		);

		if (! isset($conf->compartmentstracking) || ! isset($conf->compartmentstracking->enabled))
        {
        	$conf->compartmentstracking=new stdClass();
        	$conf->compartmentstracking->enabled=0;
        }
	...
	public function init($options='')
	{
        ...
        $this->_load_tables( '/compartmentstracking/sql/' );
